...
namespace GLv8 {
  ...
  JS_METHOD(_glut) {
    int pargc = 0;
    char** argv = NULL;
    v8::Local<v8::Object> sys = JS_GLOBAL->Get(JS_CONTEXT,JS_STR("system"))->ToObject();
    v8::Local<v8::Value> targs = sys->Get(JS_CONTEXT,JS_STR("args"));
    v8::Local<v8::Array> arr( v8::Local<v8::Array>::Cast(targs) );
    pargc = arr->Length();
    ...
    args.This()->Set(JS_CONTEXT,JS_STR("obj"),ret);
    args.GetReturnValue().Set(args.This());
  }
...
// void jsGL() {
  ...
  *pargc = arr->Length();
  ...
  exports->Set(JS_CONTEXT,JS_STR("Gl"), Gl);
  exports->Set(JS_CONTEXT,JS_STR("Gles"), Gles);
  global->Set(JS_CONTEXT,JS_STR("Glu"), ftGlu->GetFunction());
  global->Set(JS_CONTEXT,JS_STR("Glut"), ftGlut->GetFunction());

  global->Set(JS_CONTEXT,JS_STR("Gl"), Gl);
  global->Set(JS_CONTEXT,JS_STR("Glu"), Glu);
  global->Set(JS_CONTEXT,JS_STR("Gles"), Gles);
  global->Set(JS_CONTEXT,JS_STR("Glut"), Glut);
  ...
  //exports->Set(JS_CONTEXT,JS_STR("GL"), Gl->GetFunction());
  //exports->Set(JS_CONTEXT,JS_STR("Glut"), ftGlut->GetFunction());

  //exports->Set(JS_CONTEXT,JS_STR("Gl"), ftGl->GetFunction());
  //exports->Set(JS_CONTEXT,JS_STR("Gles"), ftGles->GetFunction());
  //exports->Set(JS_CONTEXT,JS_STR("Glut"), ftGlut->GetFunction());
  //exports->Set(JS_CONTEXT,JS_STR("Glut"), Glut);
}
