...
v8::Global<v8::FunctionTemplate, v8::CopyablePersistentTraits<v8::FunctionTemplate> > _byteArrayTemplate;
v8::Global<v8::Function, v8::CopyablePersistentTraits<v8::Function> > _byteArray;
...
void ByteArray_init(v8::Local<v8::FunctionTemplate> binaryTemplate) {
	...
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("slice"), v8::FunctionTemplate::New(JS_ISOLATE, _slice));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("splice"), v8::FunctionTemplate::New(JS_ISOLATE, _splice));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("displace"), v8::FunctionTemplate::New(JS_ISOLATE, _displace));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("pop"), v8::FunctionTemplate::New(JS_ISOLATE, _pop));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("shift"), v8::FunctionTemplate::New(JS_ISOLATE, _shift));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("push"), v8::FunctionTemplate::New(JS_ISOLATE, _push));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("unshift"), v8::FunctionTemplate::New(JS_ISOLATE, _unshift));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("reverse"), v8::FunctionTemplate::New(JS_ISOLATE, _reverse));
	byteArrayPrototype->Set(JS_CONTEXT,JS_STR("concat"), v8::FunctionTemplate::New(JS_ISOLATE, _concat));
