...
#define RECAST(item, type) reinterpret_cast<type>(v8::Local<v8::External>::Cast(item)->Value());
...
v8::Global<v8::FunctionTemplate> fdomexcpt;
v8::Global<v8::FunctionTemplate> fdomlsexcpt;
v8::Global<v8::FunctionTemplate> fdomlist;
v8::Global<v8::FunctionTemplate> fdomlocator;
v8::Global<v8::FunctionTemplate> fdomsource;
v8::Global<v8::FunctionTemplate> fdomreg;
v8::Global<v8::FunctionTemplate> fdom;
v8::Global<v8::FunctionTemplate> fdomls;
v8::Global<v8::FunctionTemplate> fdomconfiguration;
v8::Global<v8::FunctionTemplate> fnodefilter;
v8::Global<v8::FunctionTemplate> fparser;
v8::Global<v8::FunctionTemplate> fparserfilter;
v8::Global<v8::FunctionTemplate> fserializer;
v8::Global<v8::FunctionTemplate> fserializerfilter;
v8::Global<v8::FunctionTemplate> finput;
v8::Global<v8::FunctionTemplate> foutput;
v8::Global<v8::FunctionTemplate> fdomlsinput;

v8::Global<v8::FunctionTemplate> fdocumentfragment;
v8::Global<v8::FunctionTemplate> fnode;
v8::Global<v8::FunctionTemplate> fprocessinginstruction;
v8::Global<v8::FunctionTemplate> fdocument;
v8::Global<v8::FunctionTemplate> fpreelement;
v8::Global<v8::FunctionTemplate> felement;
v8::Global<v8::FunctionTemplate> fattribute;
v8::Global<v8::FunctionTemplate> fentityreference;
v8::Global<v8::FunctionTemplate> fcdata;
v8::Global<v8::FunctionTemplate> fcomment;
v8::Global<v8::FunctionTemplate> ftext;
v8::Global<v8::FunctionTemplate> fcdatasection;
v8::Global<v8::FunctionTemplate> fdocumenttype;
v8::Global<v8::FunctionTemplate> fentity;
v8::Global<v8::FunctionTemplate> fnotation;
v8::Global<v8::FunctionTemplate> fxpathnamespace;

/*
 *	Function templates for miscellaneous DOM class types:
 */
v8::Global<v8::FunctionTemplate> fxmlurl;
v8::Global<v8::FunctionTemplate> fstringlist;
v8::Global<v8::FunctionTemplate> fnamednodemap;
v8::Global<v8::FunctionTemplate> fnodelist;
v8::Global<v8::FunctionTemplate> fuserdata;
v8::Global<v8::FunctionTemplate> fuserdatahandler;
v8::Global<v8::FunctionTemplate> ftypeinfo;

v8::Global<v8::FunctionTemplate> fbuffer;
v8::Global<v8::FunctionTemplate> fxmemory;
v8::Global<v8::FunctionTemplate> fdommemorymanager;
v8::Global<v8::FunctionTemplate> fmemorymanager;

v8::Global<v8::FunctionTemplate> finputsource;
v8::Global<v8::FunctionTemplate> fbininput;
v8::Global<v8::FunctionTemplate> fbinfileinput;
v8::Global<v8::FunctionTemplate> fbinmeminput;
v8::Global<v8::FunctionTemplate> ffileinput;
v8::Global<v8::FunctionTemplate> fstdin;
v8::Global<v8::FunctionTemplate> furlinput;
v8::Global<v8::FunctionTemplate> fmembufinput;
v8::Global<v8::FunctionTemplate> ffileloc;
v8::Global<v8::FunctionTemplate> ffilepos;

v8::Global<v8::FunctionTemplate> fformattarget;
v8::Global<v8::FunctionTemplate> ffiletarget;
v8::Global<v8::FunctionTemplate> fmembuftarget;
v8::Global<v8::FunctionTemplate> fstdouttarget;
