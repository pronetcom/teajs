...
namespace xdom {
  ...
  JS_METHOD(_domlistitem) {
    ...
    if (dom==NULL) {
      ...
      v8::Local<v8::Object> ret( func->NewInstance(fargc, fargv) );
  ...
  JS_METHOD(_domlocatorgeturi) {
    ...
    { args.GetReturnValue().Set(JS_CONTEXT,JS_STR(ret)); return; }
  }
  ...
  JS_METHOD(_xmemorynew) {
    ...
    if (buf==NULL) {
      ...
      XMLSize_t fargc = 2;
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbuffer)->GetFunction()->NewInstance(fargc,fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_domlsinput) {
    ...
    if (args[0]->IsExternal()) {
      ...
      std::string domtype( *USTR(args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("_domtype_"))->ToString()) );
  ...
  JS_METHOD(_domlsinputgetbytestream) {
    ...
    if (src==NULL) {
      ...
      XMLSize_t fargc = 1;
      v8::Local<v8::Value> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource)->GetFunction()->NewInstance(fargc, fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_domlsoutputgetbytestream) {
    ...
    if (dst==NULL) {
      ...
      XMLSize_t fargc = 1;
      v8::Local<v8::Value> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fformattarget)->GetFunction()->NewInstance(fargc, fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_memorymanagergetexceptionmemorymanager) {
    ...
    if (exmm==NULL) {
      ...
      XMLSize_t fargc = 1;
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmemorymanager)->GetFunction()->NewInstance(fargc,fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_xmlurlgetfragment) {
    ...
    if (txt==NULL) {
      { args.GetReturnValue().Set(JS_CONTEXT,JS_STR("")); return; }
    }
    else {
      char * ret = X(txt);
      { args.GetReturnValue().Set(JS_CONTEXT,JS_STR(ret)); return; }
  ...
  JS_METHOD(_xmlurlmakenewstream) {
    ...
    if (bin==NULL) {
      args.GetReturnValue().Set(JS_CONTEXT,JS_STR("[_xmlurlmakenewstream()] ERROR: \"bin\" is a null pointer"));
      return;
    }
    else {
      XMLSize_t fargc = 1;
      v8::Local<v8::Value> fargv[] = { v8::External::New(JS_ISOLATE, (void *)bin) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbininput)->GetFunction()->NewInstance(fargc, fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_xmlurlmakerelativeto) {
    ...
    if (base==NULL) {
      args.GetReturnValue().Set(JS_CONTEXT,JS_STR("[_xmlurlmakerelativeto()] ERROR: \"base\" is a null pointer"));
      return;
    }
    else {
  ...
  JS_METHOD(_xpathgetownerelement) {
    ...
    if (el==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)el) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::felement)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_nodemapitem) {
    ...
    if (item==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)item) };
  ...
  JS_METHOD(_nodemapsetnameditem) {
	...
	v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)newNode) };
	v8::Local<v8::Object> ret(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
	{ args.GetReturnValue().Set(ret); return; };
      }
    }
  ...
  JS_METHOD(_nodelisttoarray) {
	...
	if (val==NULL) {
	  ...
	  v8::Local<v8::Object> tmp(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
  ...
  JS_METHOD(_impllscreatelsparser) {
    ...
    if (parser==NULL) {
      ...
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparser)->GetFunction()->NewInstance(fargc,fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_impllscreatelsserializer) {
    ...
    if (serializer==NULL) {
      ...
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializer)->GetFunction()->NewInstance(fargc,fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_impllscreatelsinput) {
    ...
    if (lsinput==NULL) {
      ...
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finput)->GetFunction()->NewInstance(fargc,fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_impllscreatelsoutput) {
    ...
    if (lsoutput==NULL) {
      ...
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::foutput)->GetFunction()->NewInstance(fargc,fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_impl) {
	...
	if (dom==NULL) {
	  if (args[0]->ToObject()->Has(JS_STR("DOMImplementation"))) {
	    dom = RECAST(args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("DOMImplementation"))->ToObject()->GetInternalField(0),DOMImplementation *);
	  }
	  else if (args[0]->ToObject()->Has(JS_STR("DOM"))) {
	    dom = RECAST(args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("DOM"))->ToObject()->GetInternalField(0),DOMImplementation *);
	  }
	  else if (args[0]->ToObject()->Has(JS_STR("dom"))) {
	    dom = RECAST(args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("dom"))->ToObject()->GetInternalField(0),DOMImplementation *);
	  }
	  else if (args[0]->ToObject()->Has(JS_STR("implementation"))) {
	    dom = RECAST(args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("implementation"))->ToObject()->GetInternalField(0),DOMImplementation *);
	  }
	  else {
	    schemaType = X("LS");
	    if (args[0]->ToObject()->Has(JS_STR("schema"))) {
	      schemaType = (XMLCh *) *v8::String::Utf8Value( args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("schema"))->ToString() );
	    }
  ...
  JS_METHOD(_domgetimplementation) {
    ...
    DOM;
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)dom) };
    args.GetReturnValue().Set(v8::Local<v8::Function>::Cast(args.This()->Get(JS_CONTEXT,JS_STR("DOMImplementation")))->NewInstance(1, fargs));
  }
...
//	parser = ((DOMImplementationLS *)dom)->createLSParser(xercesc_3_1::DOMImplementationLS::MODE_ASYNCHRONOUS, schemaType);
    ...
    if (parser==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)parser), v8::External::New(JS_ISOLATE, (void *)dom) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparser)->GetFunction()->NewInstance(2, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_domcreatedocumenttype) {
    ...
    if (docType==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (DOMDocumentType *)docType) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocumenttype)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_domcreatedocument) {
    ...
    if (doc==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)doc) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocument)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_serializergetdomconfig) {
    ...
    if (domconfig==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)domconfig) };
  ...
  JS_METHOD(_serializergetfilter) {
    ...
    if (filter==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)filter) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializerfilter)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_parsergetfilter) {
    ...
    if (filter==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)filter) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparserfilter)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_parsergetasync) {
    ...
    v8::Local<v8::Boolean> ret( JS_BOOL(async) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_parsergetbusy) {
    ...
    v8::Local<v8::Boolean> ret( JS_BOOL(busy) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_parserparse) {
    ...
    if (args[0]->IsExternal()) {
      ...
      v8::Local<v8::Object> tobj( args[0]->ToObject() );
      std::string domtype( *v8::String::Utf8Value(tobj->Get(JS_CONTEXT,JS_STR("_domtype_"))->ToString()) );
      if (domtype=="DOMLSInput") {
  ...
  JS_METHOD(_parsergetimplementation) {
    ...
    if (dom==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)dom) };
      v8::Local<v8::Object> obj(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->GetFunction()->NewInstance(1, fargs) );
      v8::Local<v8::Value> ret( obj );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_domconfiggetparameternames) {
    ...
    if (dslist==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)dslist) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fstringlist)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_domnode) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)node) };
    if (nodeType==xercesc_3_1::DOMNode::ELEMENT_NODE) {
      ...
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocumentfragment)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
    else if (nodeType==xercesc_3_1::DOMNode::ATTRIBUTE_NODE) {
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fattribute)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
    else if (nodeType==xercesc_3_1::DOMNode::TEXT_NODE) {
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
    else if (nodeType==xercesc_3_1::DOMNode::COMMENT_NODE) {
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcomment)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
    else if (nodeType==xercesc_3_1::DOMNode::CDATA_SECTION_NODE) {
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdatasection)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
    else {
      SAVE_PTR(0,node);
  ...
  JS_METHOD(_nodegetaselement) {
    ...
    if (node==NULL) {
      ...
      v8::Local<v8::Function> f =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction();
      v8::Local<v8::Object> ret ( f->NewInstance(fargc, fargv) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_nodeserialize) {
    ...
    if (args.Length()>1) {
      if (args[1]->IsObject()) {
	std::string domtype( *USTR(args[1]->ToObject()->Get(JS_CONTEXT,JS_STR("_domtype_"))->ToString()) );
	if (domtype=="DOMLSSerializer") {
...
//    const char * cstr = (const char *)memTarget.getRawBuffer();
      ...
      v8::Local<v8::String> ret(JS_STR(cstr));
      if (cleanSer==true) {
	pSerializer->release();
      }
      if (cleanOut==true) {
  ...
  JS_METHOD(_nodegetparentnode) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)parent) };
    v8::Local<v8::Object> ret(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_nodegetchildnodes) {
    ...
    if (nodelist==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)nodelist) };
  ...
  JS_METHOD(_nodegetfirstchild) {
    ...
    if (child==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)child) };
      v8::Local<v8::Object> ret(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_nodegetprevioussibling) {
    ...
    if (sib==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)sib) };
      v8::Local<v8::Object> ret(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_nodegetattributes) {
    ...
    if (nodemap==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)nodemap) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnamednodemap)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_nodegetownerimplementation) {
	...
	v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)impl) };
	v8::Local<v8::Object> ret (v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->GetFunction()->NewInstance(1, fargs) );
	{ args.GetReturnValue().Set(ret); return; };
      }
    }
  }
  ...
  JS_METHOD(_nodeclonenode) {
    ...
    if (clone==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)clone) };
      v8::Local<v8::Object> ret (v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_nodeappendchild) {
	...
	v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)res) };
	v8::Local<v8::Object> ret (v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs) );
	{ args.GetReturnValue().Set(ret); return; };
      }
    }
  ...
  JS_METHOD(_nodegetfeature) {
    ...
    v8::Local<v8::Value> ret ( v8::External::New(JS_ISOLATE, (void *)res) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_textsplittext) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)splitText) };
    v8::Local<v8::Object> ret ( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_dtgetentities) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (DOMNamedNodeMap *)(nodemap)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnamednodemap)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_documentcreatelsoutput) {
	...
	if (args[0]->ToObject()->Has(JS_STR("encoding"))) {
	  encoding.flush() << *v8::String::Utf8Value( args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("encoding"))->ToString() );
	}
      }
    }
  ...
  JS_METHOD(_documentcreatelsserializer) {
	...
	if (args[0]->ToObject()->Has(JS_STR("prettyPrint"))) {
	  formatprettyprint = args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("prettyPrint"))->ToBoolean()->BooleanValue();
	}
	if (args[0]->ToObject()->Has(JS_STR("discardDefaultContent"))) {
	  discarddefaultcontent = args[0]->ToObject()->Get(JS_CONTEXT,JS_STR("discardDefaultContent"))->ToBoolean()->BooleanValue();
	}
      }
      if (args.Length()>1) {
	if (args[1]->IsBoolean()) {
  ...
  JS_METHOD(_documentcreatedocumentfragment) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(frag)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocumentfragment)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_documentcreatetextnode) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(text)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_documentcreatecomment) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(comment)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcomment)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_documentcreatecdatasection) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(cdata)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdatasection)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_documentcreateprocessinginstruction) {
    ...
    if (procinst==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (DOMProcessingInstruction *)procinst) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fprocessinginstruction)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_documentcreateattribute) {
    ...
    if (attr==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (DOMAttr *)attr) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fattribute)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_documentcreateentityreference) {
    ...
    if (entityref==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(entityref)) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fentityreference)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_documentcreateattributens) {
    ...
    if (attr==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(attr)) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fattribute)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_documentgetdoctype) {
    ...
    if (docType==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(docType)) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocumenttype)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_documentgetimplementation) {
    ...
    if (dom==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(dom)) };
      v8::Local<v8::Function> impl( v8::Local<v8::Function>::Cast(JS_GLOBAL->Get(JS_CONTEXT,JS_STR("DOMImplementation"))) );
      v8::Local<v8::Object> ret( impl->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_documentcreateentity) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(entity)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fentity)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_documentcreatenotation) {
    ...
    v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)(notation)) };
    v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnotation)->GetFunction()->NewInstance(1, fargs) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  JS_METHOD(_elementsetattributenode) {
    ...
    if (ret==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)ret) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fattribute)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  JS_METHOD(_elementgetschematypeinfo) {
    ...
    if (typeinfo==NULL) {
      ...
      v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)typeinfo) };
      v8::Local<v8::Object> ret( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->GetFunction()->NewInstance(1, fargs) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  void echo_data(v8::Local<v8::String> name, const v8::PropertyCallbackInfo<v8::Value>& args) {
    v8::Local<v8::Value> ret( JS_STR(*USTR(args.Data())) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  void get_node_type(v8::Local<v8::String> name, const v8::PropertyCallbackInfo<v8::Value>& args) {
    ...
    if (nodeType==0) {
      ...
      v8::Local<v8::Integer> ret( JS_INT(nodeType) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  void get_node_name(v8::Local<v8::String> name, const v8::PropertyCallbackInfo<v8::Value>& args) {
    ...
    if (nodeName==NULL) {
      ...
      v8::Local<v8::String> ret( JS_STR(X(nodeName)) );
      { args.GetReturnValue().Set(ret); return; };
    }
  }
  ...
  void get_node_value(v8::Local<v8::String> name, const v8::PropertyCallbackInfo<v8::Value>& args) {
    ...
    if (nodeValue==NULL) {
      ...
      char * tmp = NULL;
      v8::Local<v8::Value> ret( v8::Undefined(JS_ISOLATE) );
      if (nodeValue!=NULL) {
        tmp = X(nodeValue);
        if (strlen(tmp)<1) {
  ...
  void get_property (v8::Local<v8::String> iName, const v8::PropertyCallbackInfo<v8::Value>& args) {
    ...
    if (name=="domConfig" || name=="DomConfig" || name=="DOMConfig" || name=="DOMconfig")
      ...
      funcname << "getPrefix";
    v8::Local<v8::Value> f = args.Holder()->Get(JS_CONTEXT,JS_STR(CSTR(funcname)));
    v8::Local<v8::Function> func = v8::Local<v8::Function>::Cast(f);
    v8::Local<v8::Value> ret ( func->Call(args.Holder(), fargc, fargv) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  void set_property (v8::Local<v8::String> iName, v8::Local<v8::Value> iValue, const v8::PropertyCallbackInfo<void>& args) {
    ...
    SS funcname("");
    const int fargc = 1;
    v8::Local<v8::Value> fargv[] = { iValue };
    if (name=="filter" || name=="Filter")
      ...
      funcname << "setPrefix";
    v8::Local<v8::Value> f = args.This()->Get(JS_CONTEXT,JS_STR(CSTR(funcname)));
    v8::Local<v8::Function> func = v8::Local<v8::Function>::Cast(f);
  ...
  void indexed_property_get( uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& args ) {
    ...
    v8::Local<v8::Object> This( args.Holder() );
    v8::Local<v8::Value> ret;
    XMLSize_t idx = (XMLSize_t)index;
    if (objtype=="domlist") {
      DOMImplementationList * domlist = reinterpret_cast<DOMImplementationList *>(v8::Local<v8::External>::Cast(This->GetInternalField(0))->Value());
	...
	ret =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->GetFunction()->NewInstance(1, fargs);
      ...
      DOMStringList * stringlist = reinterpret_cast<DOMStringList *>(v8::Local<v8::External>::Cast(This->GetInternalField(0))->Value());
      XMLCh * val = NULL;
	...
	ret = JS_STR(X(val));
      ...
      DOMNamedNodeMap * nodemap = reinterpret_cast<DOMNamedNodeMap *>(v8::Local<v8::External>::Cast(This->GetInternalField(0))->Value());
      DOMNode * val = NULL;
	...
	ret =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction()->NewInstance(1, fargs);
      ...
      DOMNodeList * nodelist = reinterpret_cast<DOMNodeList *>(v8::Local<v8::External>::Cast(This->GetInternalField(0))->Value());
      DOMNode * val = NULL;
  ...
  void indexed_property_set( uint32_t index, v8::Local<v8::Value> iValue, const v8::PropertyCallbackInfo<v8::Value>& args ) {
    ...
    std::string objtype( objstream.str() );
    v8::Local<v8::Object> This( args.Holder() );
    v8::Local<v8::Boolean> ret( JS_BOOL(false) );
  ...
  void indexed_property_enumerate( const v8::PropertyCallbackInfo<v8::Array>& args ) {
	...
	v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)val) };
	v8::Local<v8::Object> tmp(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->GetFunction()->NewInstance(1, fargs) );
	ret->Set(JS_INT(i), tmp);
      }
     );
    }
	...
	ret->Set(JS_INT(i), JS_STR(tmp));
     ...
     ZTRY(
      DOMNamedNodeMap * nodemap = NULL;
      nodemap = reinterpret_cast<DOMNamedNodeMap *>(v8::Local<v8::External>::Cast(This->GetInternalField(0))->Value());
      if (nodemap!=NULL) {
  ...
  void named_property_get( v8::Local<v8::String> index, const v8::PropertyCallbackInfo<v8::Value>& args ) {
	...
	if (val==NULL) {
      ...
      ZTRY(
	DOMElement * el = reinterpret_cast<DOMElement *>(v8::Local<v8::External>::Cast(This->GetInternalField(0))->Value());
	DOMElement * pel = el;
	v8::Local<v8::Value> fargs[] = { v8::External::New(JS_ISOLATE, (void *)pel) };
	v8::Local<v8::Object> pobj ( v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fpreelement)->GetFunction()->NewInstance(1, fargs) );
	v8::Local<v8::Value> pval ( pobj->Get(index) );
	XS xval = NULL;
	bool hasAttr = false;
	...
	if (retval==NULL) {
     ...
     ZTRY(
      ...
      if ( pval==true ) {
        ...
        v8::Local<v8::Function> f( v8::Local<v8::Function>::Cast(pobj->Get(JS_CONTEXT,JS_STR("setAttribute"))) );
  ...
  void named_property_query( v8::Local<v8::String> index, const v8::PropertyCallbackInfo<v8::Value>& args ) {
	...
	exists = false;
     ...
     ZTRY(
      ...
      if ( pval==true ) {
        ...
        v8::Local<v8::Boolean> tbool( JS_BOOL(hasAttr) );
    ...
    v8::Local<v8::Boolean> ret( JS_BOOL(exists) );
    { args.GetReturnValue().Set(ret); return; };
  }
  ...
  void named_property_enumerate( const v8::PropertyCallbackInfo<v8::Value>& args ) {
	...
	XMLSize_t i = 0;
	for (i = 0; i < xlen; i++) {
	  v8::Local<v8::Value> val( arr->Get(JS_INT(i)) );
...
SHARED_INIT() {
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("INDEX_SIZE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::INDEX_SIZE_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("DOMSTRING_SIZE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::DOMSTRING_SIZE_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("HIERARCHY_REQUEST_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::HIERARCHY_REQUEST_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("WRONG_DOCUMENT_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::WRONG_DOCUMENT_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("INVALID_CHARACTER_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::INVALID_CHARACTER_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("NO_DATA_ALLOWED_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::NO_DATA_ALLOWED_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("NO_MODIFICATION_ALLOWED_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::NO_MODIFICATION_ALLOWED_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("NOT_FOUND_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::NOT_FOUND_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("NOT_SUPPORTED_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::NOT_SUPPORTED_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("INUSE_ATTRIBUTE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::INUSE_ATTRIBUTE_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("INVALID_STATE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::INVALID_STATE_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("SYNTAX_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::SYNTAX_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("INVALID_MODIFICATION_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::INVALID_MODIFICATION_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("NAMESPACE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::NAMESPACE_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("INVALID_ACCESS_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::INVALID_ACCESS_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("VALIDATION_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::VALIDATION_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->Set(JS_CONTEXT,JS_STR("TYPE_MISMATCH_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMException::TYPE_MISMATCH_ERR));

    v8::Local<v8::ObjectTemplate> domexcptt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->InstanceTemplate();
    domexcptt->SetInternalFieldCount(1);
    domexcptt->Set(JS_CONTEXT,JS_STR("~DOMException"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domexcpt_destructor));
    /**
     * DOMException property accessors
     */
    domexcptt->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMException"));

    v8::Local<v8::Template> pdomexcpt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->PrototypeTemplate();
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsexcpt)->Set(JS_CONTEXT,JS_STR("PARSE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMLSException::PARSE_ERR));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsexcpt)->Set(JS_CONTEXT,JS_STR("SERIALIZE_ERR"),JS_INT((unsigned int)xercesc_3_1::DOMLSException::SERIALIZE_ERR));

    v8::Local<v8::ObjectTemplate> domlsexcptt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsexcpt)->InstanceTemplate();
    domlsexcptt->SetInternalFieldCount(1);
    domlsexcptt->Set(JS_CONTEXT,JS_STR("~DOMLSException"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsexcpt_destructor));
    /**
     * DOMLSException property accessors
     */
    domlsexcptt->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMLSException"));

    v8::Local<v8::Template> pdomlsexcpt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsexcpt)->PrototypeTemplate();
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlist)->SetClassName(JS_STR("DOMImplementationList"));
    ...
    v8::Local<v8::ObjectTemplate> domlistt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlist)->InstanceTemplate();
    domlistt->SetInternalFieldCount(1);
    domlistt->Set(JS_CONTEXT,JS_STR("~DOMImplementationList"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlist_destructor));
    domlistt->SetAccessor(JS_STR("length"), xdom::get_property);

    v8::Local<v8::String> fdomlistdata( JS_STR("domlist") );
    ...
    v8::Local<v8::Template> pdomlist =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlist)->PrototypeTemplate();
    pdomlist->Set(JS_CONTEXT,JS_STR("item"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlistitem));
    pdomlist->Set(JS_CONTEXT,JS_STR("getLength"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlistgetlength));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomsource)->SetClassName(JS_STR("DOMImplementationSource"));
    ...
    v8::Local<v8::ObjectTemplate> domsourcet =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomsource)->InstanceTemplate();
    domsourcet->SetInternalFieldCount(1);
    domsourcet->Set(JS_CONTEXT,JS_STR("~DOMImplementationSource"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domsource_destructor));
    /**
    ...
    v8::Local<v8::Template> pdomsource =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomsource)->PrototypeTemplate();
    pdomsource->Set(JS_CONTEXT,JS_STR("getDOMImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domsourcegetdomimplementation));
    pdomsource->Set(JS_CONTEXT,JS_STR("getDOMImplementationList"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domsourcegetdomimplementationlist));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlocator)->SetClassName(JS_STR("DOMLocator"));
    ...
    v8::Local<v8::ObjectTemplate> domlocatort =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlocator)->InstanceTemplate();
    domlocatort->SetInternalFieldCount(1);
    domlocatort->Set(JS_CONTEXT,JS_STR("~DOMLocator"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocator_destructor));
    ...
    v8::Local<v8::Template> pdomlocator =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlocator)->PrototypeTemplate();
    pdomlocator->Set(JS_CONTEXT,JS_STR("getLineNumber"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocatorgetlinenumber));
    pdomlocator->Set(JS_CONTEXT,JS_STR("getColumnNumber"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocatorgetcolumnnumber));
    pdomlocator->Set(JS_CONTEXT,JS_STR("getByteOffset"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocatorgetbyteoffset));
    pdomlocator->Set(JS_CONTEXT,JS_STR("getUtf16Offset"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocatorgetutf16offset));
    pdomlocator->Set(JS_CONTEXT,JS_STR("getRelatedNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocatorgetrelatednode));
    pdomlocator->Set(JS_CONTEXT,JS_STR("getURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlocatorgeturi));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomreg)->Set(JS_CONTEXT,JS_STR("getDOMImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domreggetdomimplementation));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomreg)->Set(JS_CONTEXT,JS_STR("getDOMImplementationList"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domreggetdomimplementationlist));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomreg)->Set(JS_CONTEXT,JS_STR("addSource"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domregaddsource));

    v8::Local<v8::ObjectTemplate> domregt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomreg)->InstanceTemplate();
    domregt->SetInternalFieldCount(1);
    domregt->Set(JS_CONTEXT,JS_STR("~DOMImplementationRegistry"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domreg_destructor));
    /**
    ...
    v8::Local<v8::Template> pdomreg =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomreg)->PrototypeTemplate();
  ...
  // *****						*****
    ...
    //v8::Local<v8::FunctionTemplate> fdom = v8::FunctionTemplate::New(JS_ISOLATE, xdom::_impl) ;
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->SetClassName(JS_STR("DOMImplementation"));
    ...
    v8::Local<v8::ObjectTemplate> domt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->InstanceTemplate();
    ...
    domt->Set(JS_CONTEXT,JS_STR("~DOMImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_impl_destructor));

    v8::Local<v8::Template> pt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->PrototypeTemplate();
    /**
     *	DOMImplementation prototype methods
     */
    pt->Set(JS_CONTEXT,JS_STR("getImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domgetimplementation));
    pt->Set(JS_CONTEXT,JS_STR("loadDOMExceptionMsg"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domloaddomexceptionmsg));
    pt->Set(JS_CONTEXT,JS_STR("hasFeature"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domhasfeature));
    pt->Set(JS_CONTEXT,JS_STR("createDocumentType"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domcreatedocumenttype));
    pt->Set(JS_CONTEXT,JS_STR("createDocType"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domcreatedocumenttype));
    pt->Set(JS_CONTEXT,JS_STR("createDocument"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domcreatedocument));
    pt->Set(JS_CONTEXT,JS_STR("createParser"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domcreateparser));
    pt->Set(JS_CONTEXT,JS_STR("createImplementationLS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domcreateimplementationls));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomls)->Set(JS_CONTEXT,JS_STR("MODE_ASYNCHRONOUS"),JS_INT((unsigned int)xercesc_3_1::DOMImplementationLS::MODE_ASYNCHRONOUS));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomls)->Set(JS_CONTEXT,JS_STR("MODE_SYNCHRONOUS"),JS_INT((unsigned int)xercesc_3_1::DOMImplementationLS::MODE_SYNCHRONOUS));

    v8::Local<v8::ObjectTemplate> domlst =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomls)->InstanceTemplate();
    domlst->SetInternalFieldCount(1);
    domlst->Set(JS_CONTEXT,JS_STR("~DOMImplementationLS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_implls_destructor));
    /**
     * DOMImplementationLS property accessors
     */
    domlst->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMImplementationLS"));

    v8::Local<v8::Template> plst =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomls)->PrototypeTemplate();
    /**
     * DOMImplementationLS prototype methods
     */
    plst->Set(JS_CONTEXT,JS_STR("createLSParser"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_impllscreatelsparser));
    plst->Set(JS_CONTEXT,JS_STR("createLSSerializer"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_impllscreatelsserializer));
    plst->Set(JS_CONTEXT,JS_STR("createLSOutput"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_impllscreatelsoutput));
    plst->Set(JS_CONTEXT,JS_STR("createLSInput"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_impllscreatelsinput));
  ...
  // *****						*****
    ...
    // v8::Local<v8::FunctionTemplate> fparser = v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parser);
    ...
    v8::Local<v8::ObjectTemplate> tparser = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparser)->InstanceTemplate();
    tparser->SetInternalFieldCount(2);
    tparser->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMLSParser"));

    v8::Local<v8::Template> parsert = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparser)->PrototypeTemplate();
     ...
     */
    tparser->Set(JS_CONTEXT,JS_STR("~DOMLSParser"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parser_destructor));
    parsert->Set(JS_CONTEXT,JS_STR("getDomConfig"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetdomconfig));
    parsert->Set(JS_CONTEXT,JS_STR("getFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetfilter));
    parsert->Set(JS_CONTEXT,JS_STR("getAsync"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetasync));
    parsert->Set(JS_CONTEXT,JS_STR("getBusy"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetbusy));
    parsert->Set(JS_CONTEXT,JS_STR("setFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsersetfilter));
    parsert->Set(JS_CONTEXT,JS_STR("parse"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserparse));
    parsert->Set(JS_CONTEXT,JS_STR("parseURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserparseuri));
    parsert->Set(JS_CONTEXT,JS_STR("parseWithContext"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserparsewithcontext));
    parsert->Set(JS_CONTEXT,JS_STR("abort"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserabort));
    parsert->Set(JS_CONTEXT,JS_STR("resetDocumentPool"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserresetdocumentpool));
    parsert->Set(JS_CONTEXT,JS_STR("loadGrammar"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserloadgrammar));
    parsert->Set(JS_CONTEXT,JS_STR("getGrammar"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetgrammar));
    parsert->Set(JS_CONTEXT,JS_STR("getRootGrammar"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetrootgrammar));
    parsert->Set(JS_CONTEXT,JS_STR("getURIText"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergeturitext));
    parsert->Set(JS_CONTEXT,JS_STR("resetCachedGrammarPool"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserresetcachedgrammarpool));
    parsert->Set(JS_CONTEXT,JS_STR("getSrcOffset"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetsrcoffset));
    parsert->Set(JS_CONTEXT,JS_STR("getImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parsergetimplementation));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnodefilter)->SetClassName(JS_STR("DOMNodeFilter"));
    ...
    v8::Local<v8::ObjectTemplate> tnodefilter =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnodefilter)->InstanceTemplate();
    tnodefilter->SetInternalFieldCount(1);
    tnodefilter->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMNodeFilter"));

    v8::Local<v8::Template> pnodefilter =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnodefilter)->PrototypeTemplate();
    /**
     *	DOMNodeFilter prototype methods
     */
    tnodefilter->Set(JS_CONTEXT,JS_STR("~DOMNodeFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodefilter_destructor));
    pnodefilter->Set(JS_CONTEXT,JS_STR("acceptNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodefilteracceptnode));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> tparserfilter = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparserfilter)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pparserfilter = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparserfilter)->PrototypeTemplate();
    /**
     *	DOMLSParserFilter prototype methods
     */
    tparserfilter->Set(JS_CONTEXT,JS_STR("~DOMLSParserFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserfilter_destructor));
    pparserfilter->Set(JS_CONTEXT,JS_STR("startElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserfilterstartelement));
    pparserfilter->Set(JS_CONTEXT,JS_STR("getWhatToShow"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_parserfiltergetwhattoshow));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> tserializer = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializer)->InstanceTemplate();
    tserializer->SetInternalFieldCount(2);
    tserializer->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMLSSerializer"));
    tserializer->Set(JS_CONTEXT,JS_STR("~DOMLSSerializer"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializer_destructor));

    v8::Local<v8::Template> pserializer = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializer)->PrototypeTemplate();
    pserializer->Set(JS_CONTEXT,JS_STR("getDomConfig"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializergetdomconfig));
    pserializer->Set(JS_CONTEXT,JS_STR("setNewLine"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializersetnewline));
    pserializer->Set(JS_CONTEXT,JS_STR("setFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializersetfilter));
    pserializer->Set(JS_CONTEXT,JS_STR("getNewLine"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializergetnewline));
    pserializer->Set(JS_CONTEXT,JS_STR("getFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializergetfilter));
    pserializer->Set(JS_CONTEXT,JS_STR("write"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializerwrite));
    pserializer->Set(JS_CONTEXT,JS_STR("writeToURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializerwritetouri));
    pserializer->Set(JS_CONTEXT,JS_STR("writeToString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializerwritetostring));
  ...
  // *****						*****
    ...
    // v8::Local<v8::FunctionTemplate> fserializerfilter = v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializer);
    ...
    v8::Local<v8::ObjectTemplate> tserializerfilter = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializerfilter)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pserializerfilter = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializerfilter)->PrototypeTemplate();
    /**
     *	DOMLSSerializerFilter prototype methods
     */
    tserializerfilter->Set(JS_CONTEXT,JS_STR("~DOMLSSerializerFilter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializerfilter_destructor));
    pserializerfilter->Set(JS_CONTEXT,JS_STR("getWhatToShow"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_serializerfiltergetwhattoshow));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsinput)->SetClassName(JS_STR("DOMLSInput"));
    ...
    v8::Local<v8::Template> pdomlsinput =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsinput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> domlsinputt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomlsinput)->InstanceTemplate();
     ...
     */
    domlsinputt->Set(JS_CONTEXT,JS_STR("~DOMLSInput"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinput_destructor));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getStringData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetstringdata));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getByteStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetbytestream));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetencoding));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetpublicid));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetsystemid));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getBaseURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetbaseuri));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setStringData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetstringdata));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setByteStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetbytestream));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetencoding));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetpublicid));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetsystemid));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setBaseURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetbaseuri));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("setIssueFatalErrorIfNotFound"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputsetissuefatalerrorifnotfound));
    pdomlsinput->Set(JS_CONTEXT,JS_STR("getIssueFatalErrorIfNotFound"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsinputgetissuefatalerrorifnotfound));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> toutput = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::foutput)->InstanceTemplate();
    toutput->SetInternalFieldCount(2);
    toutput->Set(JS_CONTEXT,JS_STR("~DOMLSOutput"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutput_destructor));
    toutput->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMLSOutput"));

    v8::Local<v8::Template> poutput = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::foutput)->PrototypeTemplate();
    poutput->Set(JS_CONTEXT,JS_STR("getByteStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutputgetbytestream));
    poutput->Set(JS_CONTEXT,JS_STR("getEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutputgetencoding));
    poutput->Set(JS_CONTEXT,JS_STR("getSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutputgetsystemid));
    poutput->Set(JS_CONTEXT,JS_STR("setByteStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutputsetbytestream));
    poutput->Set(JS_CONTEXT,JS_STR("setEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutputsetencoding));
    poutput->Set(JS_CONTEXT,JS_STR("setSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domlsoutputsetsystemid));
...
/*
    ...
    v8::Local<v8::ObjectTemplate> tformattarget = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fformattarget)->InstanceTemplate();
    tformattarget->SetInternalFieldCount(1);
    tformattarget->Set(JS_CONTEXT,JS_STR("~XMLFormatTarget"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_formattarget_destructor));
    tformattarget->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("XMLFormatTarget"));

    v8::Local<v8::Template> pformattarget = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fformattarget)->PrototypeTemplate();
    pformattarget->Set(JS_CONTEXT,JS_STR("writeChars"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_formattargetwritechars));
    pformattarget->Set(JS_CONTEXT,JS_STR("flush"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_formattargetflush));
...
/*
    ...
    v8::Local<v8::ObjectTemplate> tfiletarget = xdom::ffiletarget->InstanceTemplate();
    ...
    tfiletarget->Set(JS_CONTEXT,JS_STR("~v8::LocalFileFormatTarget"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_filetarget_destructor));

    v8::Local<v8::Template> pfiletarget = xdom::ffiletarget->PrototypeTemplate();
...
/*
    ...
    v8::Local<v8::ObjectTemplate> tmembuftarget = xdom::fmembuftarget->InstanceTemplate();
    ...
    tmembuftarget->Set(JS_CONTEXT,JS_STR("~MemBufFormatTarget"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_membuftarget_destructor));

    v8::Local<v8::Template> pmembuftarget = xdom::fmembuftarget->PrototypeTemplate();
    pmembuftarget->Set(JS_CONTEXT,JS_STR("getRawBuffer"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_membuftargetgetrawbuffer));
    pmembuftarget->Set(JS_CONTEXT,JS_STR("getLen"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_membuftargetgetlen));
*/
...
/*
    ...
    v8::Local<v8::ObjectTemplate> tstdouttarget = xdom::fstdouttarget->InstanceTemplate();
    tstdouttarget->SetInternalFieldCount(1);
    t->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("StdOutFormatTarget"));
    tstdouttarget->Set(JS_CONTEXT,JS_STR("~StdOutFormatTarget"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_stdouttarget_destructor));

    v8::Local<v8::Template> pstdouttarget = xdom::fstdouttarget->PrototypeTemplate();
*/
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> stringlistt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fstringlist)->InstanceTemplate();
    ...
    v8::Local<v8::String> fstringlistdata( JS_STR("stringlist") );
    ...
    //stringlistt->SetNamedPropertyv8::Localr(xdom::named_property_get, NULL, xdom::named_property_query, NULL, xdom::named_property_enumerate, fstringlistdata);

    v8::Local<v8::Template> tstringlist = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fstringlist)->PrototypeTemplate();
    //	DOMStringList prototype methods
    stringlistt->Set(JS_CONTEXT,JS_STR("~DOMStringList"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_stringlist_destructor));
    tstringlist->Set(JS_CONTEXT,JS_STR("item"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_stringlistitem));
    tstringlist->Set(JS_CONTEXT,JS_STR("getLength"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_stringlistgetlength));
    tstringlist->Set(JS_CONTEXT,JS_STR("contains"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_stringlistcontains));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> namednodemapt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnamednodemap)->InstanceTemplate();
    ...
    v8::Local<v8::String> fnamednodemapdata( JS_STR("namednodemap") );
    ...
    //namednodemapt->SetNamedPropertyv8::Localr(xdom::named_property_get, xdom::named_property_set, xdom::named_property_query, xdom::named_property_delete, xdom::named_property_enumerate, fnamednodemapdata);
    ...
    //namednodemapt->SetNamedPropertyv8::Localr(xdom::named_property_get, NULL, xdom::named_property_query, NULL, xdom::named_property_enumerate, fnamednodemapdata);

    v8::Local<v8::ObjectTemplate> tnamednodemap = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnamednodemap)->PrototypeTemplate();
    //	DOMNamedNodeMap prototype methods
    namednodemapt->Set(JS_CONTEXT,JS_STR("~DOMNamedNodeMap"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_namednodemap_destructor));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("item"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapitem));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("getLength"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapgetlength));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("getNamedItem"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapgetnameditem));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("getNamedItemNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapgetnameditemns));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("setNamedItem"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapsetnameditem));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("setNamedItemNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapsetnameditemns));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("removeNamedItem"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapremovenameditem));
    tnamednodemap->Set(JS_CONTEXT,JS_STR("removeNamedItemNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodemapremovenameditemns));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnodelist)->SetClassName(JS_STR("DOMNodeList"));
    ...
    v8::Local<v8::String> fnodelistdata( JS_STR("nodelist") );

    v8::Local<v8::ObjectTemplate> nodelistt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnodelist)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pnodelist =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnodelist)->PrototypeTemplate();
    //	DOMNodeList prototype methods
    nodelistt->Set(JS_CONTEXT,JS_STR("~DOMNodeList"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodelist_destructor));
    pnodelist->Set(JS_CONTEXT,JS_STR("item"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodelistitem));
    pnodelist->Set(JS_CONTEXT,JS_STR("getLength"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodelistgetlength));
    pnodelist->Set(JS_CONTEXT,JS_STR("toArray"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodelisttoarray));
  ...
  // *****						*****
    ...
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->Set(JS_CONTEXT,JS_STR("NODE_CLONED"), JS_INT(xercesc_3_1::DOMUserDataHandler::NODE_CLONED));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->Set(JS_CONTEXT,JS_STR("NODE_IMPORTED"), JS_INT(xercesc_3_1::DOMUserDataHandler::NODE_IMPORTED));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->Set(JS_CONTEXT,JS_STR("NODE_DELETED"), JS_INT(xercesc_3_1::DOMUserDataHandler::NODE_DELETED));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->Set(JS_CONTEXT,JS_STR("NODE_RENAMED"), JS_INT(xercesc_3_1::DOMUserDataHandler::NODE_RENAMED));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->Set(JS_CONTEXT,JS_STR("NODE_ADOPTED"), JS_INT(xercesc_3_1::DOMUserDataHandler::NODE_ADOPTED));

    v8::Local<v8::ObjectTemplate> userdatahandlert = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->InstanceTemplate();
    ...
    v8::Local<v8::Template> puserdatahandler = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fuserdatahandler)->PrototypeTemplate();

    //	DOMUserDataHandler prototype methods
    userdatahandlert->Set(JS_CONTEXT,JS_STR("~DOMUserDataHandler"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domuserdatahandler_destructor));
    puserdatahandler->Set(JS_CONTEXT,JS_STR("handle"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domuserdatahandlerhandle));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomconfiguration)->SetClassName(JS_STR("DOMConfiguration"));
    ...
    v8::Local<v8::ObjectTemplate> domconfigurationt =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomconfiguration)->InstanceTemplate();
     ...
     */
    domconfigurationt->Set(JS_CONTEXT,JS_STR("childCount"), JS_INT(1));

    v8::Local<v8::ObjectTemplate> tdomconfiguration =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomconfiguration)->PrototypeTemplate();

    /**
     * DOM prototype methods (new Document().*)
     */
    domconfigurationt->Set(JS_CONTEXT,JS_STR("~DOMConfiguration"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domconfiguration_destructor));
    tdomconfiguration->Set(JS_CONTEXT,JS_STR("getParameter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domconfiggetparameter));
    tdomconfiguration->Set(JS_CONTEXT,JS_STR("setParameter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domconfigsetparameter));
    tdomconfiguration->Set(JS_CONTEXT,JS_STR("canSetParameter"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domconfigcansetparameter));
    tdomconfiguration->Set(JS_CONTEXT,JS_STR("getParameterNames"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domconfiggetparameternames));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->SetClassName(JS_STR("DOMNode"));
    ...
    v8::Local<v8::ObjectTemplate> nodet(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->InstanceTemplate() );
    nodet->SetInternalFieldCount(1);
    nodet->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMNode"));

    v8::Local<v8::Template> pnode(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->PrototypeTemplate() );
	...
	*	(see "http://xerces.apache.org/xerces-c/apiDocs-3/classDOMTypeInfo.html" for enumerated values)
     *	*/
      // "NodeType":
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("ELEMENT_NODE"), JS_INT(xercesc_3_1::DOMNode::ELEMENT_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("ATTRIBUTE_NODE"), JS_INT(xercesc_3_1::DOMNode::ATTRIBUTE_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("TEXT_NODE"), JS_INT(xercesc_3_1::DOMNode::TEXT_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("CDATA_SECTION_NODE"), JS_INT(xercesc_3_1::DOMNode::CDATA_SECTION_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("ENTITY_REFERENCE_NODE"), JS_INT(xercesc_3_1::DOMNode::ENTITY_REFERENCE_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("ENTITY_NODE"), JS_INT(xercesc_3_1::DOMNode::ENTITY_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("PROCESSING_INSTRUCTION_NODE"), JS_INT(xercesc_3_1::DOMNode::PROCESSING_INSTRUCTION_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("COMMENT_NODE"), JS_INT(xercesc_3_1::DOMNode::COMMENT_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_NODE"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_TYPE_NODE"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_TYPE_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_FRAGMENT_NODE"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_FRAGMENT_NODE));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("NOTATION_NODE"), JS_INT(xercesc_3_1::DOMNode::NOTATION_NODE));
      // "DocumentPosition":
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_POSITION_DISCONNECTED"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_POSITION_DISCONNECTED));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_POSITION_PRECEDING"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_POSITION_PRECEDING));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_POSITION_FOLLOWING"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_POSITION_FOLLOWING));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_POSITION_CONTAINS"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_POSITION_CONTAINS));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_POSITION_CONTAINED_BY"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_POSITION_CONTAINED_BY));
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->Set(JS_CONTEXT,JS_STR("DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC"), JS_INT(xercesc_3_1::DOMNode::DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC));
     ...
     * prototype methods
     */
    nodet->Set(JS_CONTEXT,JS_STR("~DOMNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_domnode_destructor));
    pnode->Set(JS_CONTEXT,JS_STR("serialize"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    pnode->Set(JS_CONTEXT,JS_STR("getOuterHTML"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    pnode->Set(JS_CONTEXT,JS_STR("getOuterHtml"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    pnode->Set(JS_CONTEXT,JS_STR("getOuterXML"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    pnode->Set(JS_CONTEXT,JS_STR("getOuterXml"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    pnode->Set(JS_CONTEXT,JS_STR("getInnerHTML"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserializeinner));
    pnode->Set(JS_CONTEXT,JS_STR("getInnerHtml"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserializeinner));
    pnode->Set(JS_CONTEXT,JS_STR("getInnerXML"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserializeinner));
    pnode->Set(JS_CONTEXT,JS_STR("getInnerXml"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserializeinner));
    // pnode->Set(JS_CONTEXT,JS_STR("toString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    pnode->Set(JS_CONTEXT,JS_STR("getAsElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetaselement));
    pnode->Set(JS_CONTEXT,JS_STR("getNodeName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetnodename));
    pnode->Set(JS_CONTEXT,JS_STR("getNodev8::Value"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetnodevalue));
    pnode->Set(JS_CONTEXT,JS_STR("getNodeType"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetnodetype));
    pnode->Set(JS_CONTEXT,JS_STR("getParentNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetparentnode));
    pnode->Set(JS_CONTEXT,JS_STR("getChildNodes"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetchildnodes));
    pnode->Set(JS_CONTEXT,JS_STR("getFirstChild"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetfirstchild));
    pnode->Set(JS_CONTEXT,JS_STR("getLastChild"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetlastchild));
    pnode->Set(JS_CONTEXT,JS_STR("getPreviousSibling"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetprevioussibling));
    pnode->Set(JS_CONTEXT,JS_STR("getNextSibling"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetnextsibling));
    pnode->Set(JS_CONTEXT,JS_STR("getAttributes"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetattributes));
    pnode->Set(JS_CONTEXT,JS_STR("getOwnerDocument"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetownerdocument));
    pnode->Set(JS_CONTEXT,JS_STR("getImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetownerimplementation));
    pnode->Set(JS_CONTEXT,JS_STR("cloneNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeclonenode));
    pnode->Set(JS_CONTEXT,JS_STR("insertBefore"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeinsertbefore));
    pnode->Set(JS_CONTEXT,JS_STR("replaceChild"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodereplacechild));
    pnode->Set(JS_CONTEXT,JS_STR("removeChild"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_noderemovechild));
    pnode->Set(JS_CONTEXT,JS_STR("appendChild"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeappendchild));
    pnode->Set(JS_CONTEXT,JS_STR("hasChildNodes"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodehaschildnodes));
    pnode->Set(JS_CONTEXT,JS_STR("setNodev8::Value"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodesetnodevalue));
    pnode->Set(JS_CONTEXT,JS_STR("normalize"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodenormalize));
    pnode->Set(JS_CONTEXT,JS_STR("isSupported"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeissupported));
    pnode->Set(JS_CONTEXT,JS_STR("getNamespaceURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetnamespaceuri));
    pnode->Set(JS_CONTEXT,JS_STR("getPrefix"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetprefix));
    pnode->Set(JS_CONTEXT,JS_STR("getv8::LocalName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetlocalname));
    pnode->Set(JS_CONTEXT,JS_STR("setPrefix"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodesetprefix));
    pnode->Set(JS_CONTEXT,JS_STR("hasAttributes"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodehasattributes));
    pnode->Set(JS_CONTEXT,JS_STR("isSameNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeissamenode));
    pnode->Set(JS_CONTEXT,JS_STR("isEqualNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeisequalnode));
    pnode->Set(JS_CONTEXT,JS_STR("setUserData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodesetuserdata));
    pnode->Set(JS_CONTEXT,JS_STR("getUserData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetuserdata));
    pnode->Set(JS_CONTEXT,JS_STR("getBaseURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetbaseuri));
    pnode->Set(JS_CONTEXT,JS_STR("compareDocumentPosition"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodecomparedocumentposition));
    pnode->Set(JS_CONTEXT,JS_STR("getTextContent"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegettextcontent));
    pnode->Set(JS_CONTEXT,JS_STR("setTextContent"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodesettextcontent));
    pnode->Set(JS_CONTEXT,JS_STR("lookupPrefix"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodelookupprefix));
    pnode->Set(JS_CONTEXT,JS_STR("isDefaultNamespace"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeisdefaultnamespace));
    pnode->Set(JS_CONTEXT,JS_STR("lookupNamespaceURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodelookupnamespaceuri));
    pnode->Set(JS_CONTEXT,JS_STR("getFeature"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodegetfeature));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pdocumenttype = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocumenttype)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> documenttypet = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocumenttype)->InstanceTemplate();
     ...
     * prototype methods
     */
    documenttypet->Set(JS_CONTEXT,JS_STR("~DOMDocumentType"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documenttype_destructor));
    pdocumenttype->Set(JS_CONTEXT,JS_STR("getName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dtgetname));
    pdocumenttype->Set(JS_CONTEXT,JS_STR("getEntities"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dtgetentities));
    pdocumenttype->Set(JS_CONTEXT,JS_STR("getNotations"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dtgetnotations));
    pdocumenttype->Set(JS_CONTEXT,JS_STR("getPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dtgetpublicid));
    pdocumenttype->Set(JS_CONTEXT,JS_STR("getSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dtgetsystemid));
    pdocumenttype->Set(JS_CONTEXT,JS_STR("getInternalSubset"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dtgetinternalsubset));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> documentt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocument)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pdocument = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdocument)->PrototypeTemplate();

    /**
     * Document prototype methods
     */
    documentt->Set(JS_CONTEXT,JS_STR("~DOMDocument"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_document_destructor));
    // pdocument->Set(JS_CONTEXT,JS_STR("toString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentserialize));
    pdocument->Set(JS_CONTEXT,JS_STR("serialize"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentserialize));
    pdocument->Set(JS_CONTEXT,JS_STR("createLSSerializer"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatelsserializer));
    pdocument->Set(JS_CONTEXT,JS_STR("createLSOutput"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatelsoutput));
    pdocument->Set(JS_CONTEXT,JS_STR("createNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatenode));
    pdocument->Set(JS_CONTEXT,JS_STR("createElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreateelement));
    pdocument->Set(JS_CONTEXT,JS_STR("createDocumentFragment"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatedocumentfragment));
    pdocument->Set(JS_CONTEXT,JS_STR("createTextNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatetextnode));
    pdocument->Set(JS_CONTEXT,JS_STR("createComment"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatecomment));
    pdocument->Set(JS_CONTEXT,JS_STR("createCDATASection"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreatecdatasection));
    pdocument->Set(JS_CONTEXT,JS_STR("createProcessingInstruction"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreateprocessinginstruction));
    pdocument->Set(JS_CONTEXT,JS_STR("createAttribute"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreateattribute));
    pdocument->Set(JS_CONTEXT,JS_STR("createEntityReference"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreateentityreference));
    pdocument->Set(JS_CONTEXT,JS_STR("getDocType"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetdoctype));
    pdocument->Set(JS_CONTEXT,JS_STR("getImplementation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetimplementation));
    pdocument->Set(JS_CONTEXT,JS_STR("getDocumentElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetdocumentelement));
    pdocument->Set(JS_CONTEXT,JS_STR("getElementsByTagName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetelementsbytagname));
    pdocument->Set(JS_CONTEXT,JS_STR("importNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentimportnode));
    pdocument->Set(JS_CONTEXT,JS_STR("createElementNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreateelementns));
    pdocument->Set(JS_CONTEXT,JS_STR("createAttributeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentcreateattributens));
    pdocument->Set(JS_CONTEXT,JS_STR("getElementsByTagNameNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetelementsbytagnamens));
    pdocument->Set(JS_CONTEXT,JS_STR("getElementById"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetelementbyid));
    pdocument->Set(JS_CONTEXT,JS_STR("getInputEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetinputencoding));
    pdocument->Set(JS_CONTEXT,JS_STR("getXmlEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetxmlencoding));
    pdocument->Set(JS_CONTEXT,JS_STR("getXmlStandalone"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetxmlstandalone));
    pdocument->Set(JS_CONTEXT,JS_STR("setXmlStandalone"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentsetxmlstandalone));
    pdocument->Set(JS_CONTEXT,JS_STR("getXmlVersion"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetxmlversion));
    pdocument->Set(JS_CONTEXT,JS_STR("setXmlVersion"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentsetxmlversion));
    pdocument->Set(JS_CONTEXT,JS_STR("getDocumentURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetdocumenturi));
    pdocument->Set(JS_CONTEXT,JS_STR("setDocumentURI"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentsetdocumenturi));
    pdocument->Set(JS_CONTEXT,JS_STR("getStrictErrorChecking"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetstricterrorchecking));
    pdocument->Set(JS_CONTEXT,JS_STR("setStrictErrorChecking"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentsetstricterrorchecking));
    pdocument->Set(JS_CONTEXT,JS_STR("renameNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentrenamenode));
    pdocument->Set(JS_CONTEXT,JS_STR("adoptNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentadoptnode));
    pdocument->Set(JS_CONTEXT,JS_STR("normalizeDocument"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentnormalizedocument));
    pdocument->Set(JS_CONTEXT,JS_STR("getDOMConfig"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_documentgetdomconfig));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> attributet = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fattribute)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pattribute = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fattribute)->PrototypeTemplate();

    /**
     * Attribute prototype methods
     */
    attributet->Set(JS_CONTEXT,JS_STR("~DOMAttr"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attribute_destructor));
    pattribute->Set(JS_CONTEXT,JS_STR("getName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetname));
    pattribute->Set(JS_CONTEXT,JS_STR("getSpecified"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetspecified));
    pattribute->Set(JS_CONTEXT,JS_STR("getv8::Value"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetvalue));
    pattribute->Set(JS_CONTEXT,JS_STR("setv8::Value"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributesetvalue));
    pattribute->Set(JS_CONTEXT,JS_STR("valueOf"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetvalue));
    pattribute->Set(JS_CONTEXT,JS_STR("v8::ValueOf"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetvalue));
    pattribute->Set(JS_CONTEXT,JS_STR("toString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetvalue));
    pattribute->Set(JS_CONTEXT,JS_STR("ToString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetvalue));
    pattribute->Set(JS_CONTEXT,JS_STR("getOwnerElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetownerelement));
    pattribute->Set(JS_CONTEXT,JS_STR("isId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributeisid));
    pattribute->Set(JS_CONTEXT,JS_STR("getSchemaTypeInfo"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_attributegetschematypeinfo));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> preelementt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fpreelement)->InstanceTemplate();
    ...
    v8::Local<v8::Template> ppreelement = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fpreelement)->PrototypeTemplate();

    /**
     * PreElement prototype methods
     */
    preelementt->Set(JS_CONTEXT,JS_STR("~PreElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_preelement_destructor));
    //ppreelement->Set(JS_CONTEXT,JS_STR("toString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_nodeserialize));
    ppreelement->Set(JS_CONTEXT,JS_STR("getAsNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetasnode));
    ppreelement->Set(JS_CONTEXT,JS_STR("setAttribute"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetattribute));
    ppreelement->Set(JS_CONTEXT,JS_STR("setAttributeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetattributens));
    ppreelement->Set(JS_CONTEXT,JS_STR("setAttributeNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetattributenode));
    ppreelement->Set(JS_CONTEXT,JS_STR("setAttributeNodeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetattributenodens));
    ppreelement->Set(JS_CONTEXT,JS_STR("getTagName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgettagname));
    ppreelement->Set(JS_CONTEXT,JS_STR("getAttribute"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetattribute));
    ppreelement->Set(JS_CONTEXT,JS_STR("getAttributeNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetattributenode));
    ppreelement->Set(JS_CONTEXT,JS_STR("getElementsByTagName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetelementsbytagname));
    ppreelement->Set(JS_CONTEXT,JS_STR("removeAttribute"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementremoveattribute));
    ppreelement->Set(JS_CONTEXT,JS_STR("removeAttributeNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementremoveattributenode));
    ppreelement->Set(JS_CONTEXT,JS_STR("getAttributeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetattributens));
    ppreelement->Set(JS_CONTEXT,JS_STR("removeAttributeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementremoveattributens));
    ppreelement->Set(JS_CONTEXT,JS_STR("getAttributeNodeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetattributenodens));
    ppreelement->Set(JS_CONTEXT,JS_STR("getElementsByTagNameNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetelementsbytagnamens));
    ppreelement->Set(JS_CONTEXT,JS_STR("hasAttribute"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementhasattribute));
    ppreelement->Set(JS_CONTEXT,JS_STR("hasAttributeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementhasattributens));
    ppreelement->Set(JS_CONTEXT,JS_STR("setIdAttribute"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetidattribute));
    ppreelement->Set(JS_CONTEXT,JS_STR("setIdAttributeNS"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetidattributens));
    ppreelement->Set(JS_CONTEXT,JS_STR("setIdAttributeNode"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementsetidattributenode));
    ppreelement->Set(JS_CONTEXT,JS_STR("getSchemaTypeInfo"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_elementgetschematypeinfo));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::felement)->SetClassName(JS_STR("DOMElement"));
    ...
    v8::Local<v8::ObjectTemplate> elementt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::felement)->InstanceTemplate();
    ...
    elementt->SetAccessor(JS_STR("Node"),xdom::get_as_node);
    //elementt->SetNamedPropertyv8::Localr(xdom::named_property_get, xdom::named_property_set, xdom::named_property_query, xdom::named_property_delete, xdom::named_property_enumerate, felementdata);

    v8::Local<v8::Template> pelement = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::felement)->PrototypeTemplate();

    /**
     * Element prototype methods
     */
    elementt->Set(JS_CONTEXT,JS_STR("~DOMElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_element_destructor));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pcdata = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdata)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> cdatat = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdata)->InstanceTemplate();
     ...
     */
    cdatat->Set(JS_CONTEXT,JS_STR("~DOMCharacterData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdata_destructor));
    pcdata->Set(JS_CONTEXT,JS_STR("getData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatagetdata));
    pcdata->Set(JS_CONTEXT,JS_STR("getLength"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatagetlength));
    pcdata->Set(JS_CONTEXT,JS_STR("substringData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatasubstringdata));
    pcdata->Set(JS_CONTEXT,JS_STR("appendData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdataappenddata));
    pcdata->Set(JS_CONTEXT,JS_STR("insertData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatainsertdata));
    pcdata->Set(JS_CONTEXT,JS_STR("deleteData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatadeletedata));
    pcdata->Set(JS_CONTEXT,JS_STR("replaceData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatareplacedata));
    pcdata->Set(JS_CONTEXT,JS_STR("setData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatasetdata));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext)->SetClassName(JS_STR("DOMText"));
    ...
    v8::Local<v8::Template> ptextnode = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> textnodet = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext)->InstanceTemplate();
     ...
     */
    textnodet->Set(JS_CONTEXT,JS_STR("~DOMText"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_text_destructor));
    ptextnode->Set(JS_CONTEXT,JS_STR("splitText"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_textsplittext));
    ptextnode->Set(JS_CONTEXT,JS_STR("getIsElementContentWhitespace"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_textgetiselementcontentwhitespace));
    ptextnode->Set(JS_CONTEXT,JS_STR("getWholeText"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_textgetwholetext));
    ptextnode->Set(JS_CONTEXT,JS_STR("replaceWholeText"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_textreplacewholetext));
    ptextnode->Set(JS_CONTEXT,JS_STR("isIgnorableWhitespace"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_textisignorablewhitespace));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdatasection)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftext));
    ...
    v8::Local<v8::ObjectTemplate> cdatasectiont = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdatasection)->InstanceTemplate();
     ...
     */
    cdatasectiont->Set(JS_CONTEXT,JS_STR("~DOMCDATASection"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_cdatasection_destructor));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcomment)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcdata));
    ...
    v8::Local<v8::ObjectTemplate> commentt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fcomment)->InstanceTemplate();
     ...
     */
    commentt->Set(JS_CONTEXT,JS_STR("~DOMComment"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_comment_destructor));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pentity = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fentity)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> entityt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fentity)->InstanceTemplate();
     ...
     */
    entityt->Set(JS_CONTEXT,JS_STR("~DOMEntity"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entity_destructor));
    pentity->Set(JS_CONTEXT,JS_STR("getPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entitygetpublicid));
    pentity->Set(JS_CONTEXT,JS_STR("getSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entitygetsystemid));
    pentity->Set(JS_CONTEXT,JS_STR("getNotationName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entitygetnotationname));
    pentity->Set(JS_CONTEXT,JS_STR("getInputEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entitygetinputencoding));
    pentity->Set(JS_CONTEXT,JS_STR("getXmlEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entitygetxmlencoding));
    pentity->Set(JS_CONTEXT,JS_STR("getXmlVersion"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entitygetxmlversion));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> entityreferencet = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fentityreference)->InstanceTemplate();
     ...
     */
    entityreferencet->Set(JS_CONTEXT,JS_STR("~DOMEntityReference"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_entityreference_destructor));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> processinginstructiont = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fprocessinginstruction)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pprocessinginstruction = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fprocessinginstruction)->PrototypeTemplate();

    /**
     * ProcessingInstruction prototype methods
     */
    processinginstructiont->Set(JS_CONTEXT,JS_STR("~DOMProcessingInstruction"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_processinginstruction_destructor));
    pprocessinginstruction->Set(JS_CONTEXT,JS_STR("getData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_processinginstructiongetdata));
    pprocessinginstruction->Set(JS_CONTEXT,JS_STR("setData"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_processinginstructionsetdata));
    pprocessinginstruction->Set(JS_CONTEXT,JS_STR("getTarget"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_processinginstructiongettarget));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> notationt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnotation)->InstanceTemplate();
    ...
    v8::Local<v8::Template> pnotation = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnotation)->PrototypeTemplate();

    /**
     *	DOMNotation prototype methods
     */
    notationt->Set(JS_CONTEXT,JS_STR("~DOMNotation"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_notation_destructor));
    pnotation->Set(JS_CONTEXT,JS_STR("getPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_notationgetpublicid));
    pnotation->Set(JS_CONTEXT,JS_STR("getSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_notationgetsystemid));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pbuffer = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbuffer)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> buffert = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbuffer)->InstanceTemplate();
     ...
     */
    buffert->Set(JS_CONTEXT,JS_STR("~Buffer"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_buffer_destructor));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pmemorymanager = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmemorymanager)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> memorymanagert = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmemorymanager)->InstanceTemplate();
     ...
     */
    memorymanagert->Set(JS_CONTEXT,JS_STR("~MemoryManager"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_memorymanager_destructor));
    pmemorymanager->Set(JS_CONTEXT,JS_STR("getExceptionMemoryManager"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_memorymanagergetexceptionmemorymanager));
    pmemorymanager->Set(JS_CONTEXT,JS_STR("allocate"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_memorymanagerallocate));
    pmemorymanager->Set(JS_CONTEXT,JS_STR("deallocate"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_memorymanagerdeallocate));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdommemorymanager)->SetClassName(JS_STR("DOMMemoryManager"));
    ...
    v8::Local<v8::Template> pdommemorymanager =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdommemorymanager)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> dommemorymanagert =v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdommemorymanager)->InstanceTemplate();
     ...
     */
    dommemorymanagert->Set(JS_CONTEXT,JS_STR("~DOMMemoryManager"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dommemorymanager_destructor));
    pdommemorymanager->Set(JS_CONTEXT,JS_STR("getMemoryAllocationBlockSize"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dommemorymanagergetmemoryallocationblocksize));
    pdommemorymanager->Set(JS_CONTEXT,JS_STR("setMemoryAllocationBlockSize"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dommemorymanagersetmemoryallocationblocksize));
    pdommemorymanager->Set(JS_CONTEXT,JS_STR("allocate"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dommemorymanagerallocate));
//    pdommemorymanager->Set(JS_CONTEXT,JS_STR("release"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dommemorymanagerrelease));
    pdommemorymanager->Set(JS_CONTEXT,JS_STR("cloneString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_dommemorymanagerclonestring));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pxmemory = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmemory)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> xmemoryt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmemory)->InstanceTemplate();
     ...
     */
    xmemoryt->Set(JS_CONTEXT,JS_STR("~XMemory"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmemory_destructor));
    pxmemory->Set(JS_CONTEXT,JS_STR("New"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmemorynew));
    pxmemory->Set(JS_CONTEXT,JS_STR("Delete"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmemorydelete));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbininput)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmemory));
    ...
    v8::Local<v8::Template> pbininputstream = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbininput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> bininputstreamt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbininput)->InstanceTemplate();
     ...
     */
    bininputstreamt->Set(JS_CONTEXT,JS_STR("~BinInputStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_bininput_destructor));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbinfileinput)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbininput));
    ...
    v8::Local<v8::Template> pbinfileinput = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbinfileinput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> binfileinputt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbinfileinput)->InstanceTemplate();
     ...
     */
    binfileinputt->Set(JS_CONTEXT,JS_STR("~BinFileInputStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_binfileinput_destructor));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pbinmeminputstream = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbinmeminput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> binmeminputstreamt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fbinmeminput)->InstanceTemplate();
     ...
     */
    binmeminputstreamt->Set(JS_CONTEXT,JS_STR("~BinMemInputStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_binmeminputstream_destructor));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmemory));
    ...
    v8::Local<v8::Template> pinputsource = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> inputsourcet = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource)->InstanceTemplate();
     ...
     */
    inputsourcet->Set(JS_CONTEXT,JS_STR("~InputSource"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsource_destructor));
    pinputsource->Set(JS_CONTEXT,JS_STR("makeStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcemakestream));
    pinputsource->Set(JS_CONTEXT,JS_STR("getEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcegetencoding));
    pinputsource->Set(JS_CONTEXT,JS_STR("getPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcegetpublicid));
    pinputsource->Set(JS_CONTEXT,JS_STR("getSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcegetsystemid));
    pinputsource->Set(JS_CONTEXT,JS_STR("getIssueFatalErrorIfNotFound"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcegetissuefatalerrorifnotfound));
    pinputsource->Set(JS_CONTEXT,JS_STR("getMemoryManager"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcegetmemorymanager));
    pinputsource->Set(JS_CONTEXT,JS_STR("setEncoding"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcesetencoding));
    pinputsource->Set(JS_CONTEXT,JS_STR("setPublicId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcesetpublicid));
    pinputsource->Set(JS_CONTEXT,JS_STR("setSystemId"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcesetsystemid));
    pinputsource->Set(JS_CONTEXT,JS_STR("setIssueFatalErrorIfNotFound"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_inputsourcesetissuefatalerrorifnotfound));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ffileinput)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource));
    ...
    v8::Local<v8::Template> pfileinput = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ffileinput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> fileinputt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ffileinput)->InstanceTemplate();
     ...
     */
    fileinputt->Set(JS_CONTEXT,JS_STR("~LocalFileInputSource "), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_fileinput_destructor));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmembufinput)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource));
    ...
    v8::Local<v8::Template> pmembufinput = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmembufinput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> membufinputt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmembufinput)->InstanceTemplate();
     ...
     */
    membufinputt->Set(JS_CONTEXT,JS_STR("~MemBufInputSource"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_membufinput_destructor));
    pmembufinput->Set(JS_CONTEXT,JS_STR("setCopyBufToStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_membufinputsetcopybuftostream));
    pmembufinput->Set(JS_CONTEXT,JS_STR("resetMemBufInputSource"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_membufinputresetmembufinputsource));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fstdin)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource));
    ...
    v8::Local<v8::Template> pstdin = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fstdin)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> stdint = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fstdin)->InstanceTemplate();
     ...
     */
    stdint->Set(JS_CONTEXT,JS_STR("~StdInInputSource "), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_stdin_destructor));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::furlinput)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource));
    ...
    v8::Local<v8::Template> purlinput = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::furlinput)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> urlinputt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::furlinput)->InstanceTemplate();
     ...
     */
    urlinputt->Set(JS_CONTEXT,JS_STR("~URLInputSource "), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_urlinput_destructor));
  ...
  // *****						*****
   ...
   v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmlurl)->Inherit(v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::finputsource));
    ...
    v8::Local<v8::Template> pxmlurl = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmlurl)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> xmlurlt = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmlurl)->InstanceTemplate();
     ...
     */
    xmlurlt->Set(JS_CONTEXT,JS_STR("~XMLURL"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurl_destructor));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getFragment"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetfragment));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getHost"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgethost));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getPassword"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetpassword));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getPath"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetpath));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getPortNum"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetportnum));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getProtocolName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetprotocolname));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getQuery"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetquery));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getURIText"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgeturltext));
    pxmlurl->Set(JS_CONTEXT,JS_STR("getUser"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgetuser));
    pxmlurl->Set(JS_CONTEXT,JS_STR("hasInvalidChar"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlhasinvalidchar));
    pxmlurl->Set(JS_CONTEXT,JS_STR("makeNewStream"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlmakenewstream));
    pxmlurl->Set(JS_CONTEXT,JS_STR("makeRelativeTo"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlmakerelativeto));
    pxmlurl->Set(JS_CONTEXT,JS_STR("lookupByName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurllookupbyname));
    pxmlurl->Set(JS_CONTEXT,JS_STR("parse"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlparse));
    pxmlurl->Set(JS_CONTEXT,JS_STR("toString"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xmlurlgeturltext));
  ...
  // *****						*****
    ...
    v8::Local<v8::Template> pxpathnamespace = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxpathnamespace)->PrototypeTemplate();

    v8::Local<v8::ObjectTemplate> xpathnamespacet = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxpathnamespace)->InstanceTemplate();
     ...
     */
    xpathnamespacet->Set(JS_CONTEXT,JS_STR("~DOMXPathNamespace"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xpathnamespace_destructor));
    pxpathnamespace->Set(JS_CONTEXT,JS_STR("getOwnerElement"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_xpathgetownerelement));
  ...
  // *****						*****
    ...
    v8::Local<v8::ObjectTemplate> typeinfot = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->InstanceTemplate();
    typeinfot->SetInternalFieldCount(1);
    typeinfot->SetAccessor(JS_STR("_domtype_"), xdom::echo_data, NULL, JS_STR("DOMTypeInfo"));

    v8::Local<v8::Template> ttypeinfo = v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->PrototypeTemplate();
	...
	*	(see "http://xerces.apache.org/xerces-c/apiDocs-3/classDOMTypeInfo.html" for enumerated values)
     *	*/
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->Set(JS_CONTEXT,JS_STR("DERIVATION_EXTENSION"), JS_INT(xercesc_3_1::DOMTypeInfo::DERIVATION_EXTENSION));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->Set(JS_CONTEXT,JS_STR("DERIVATION_LIST"), JS_INT(xercesc_3_1::DOMTypeInfo::DERIVATION_LIST));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->Set(JS_CONTEXT,JS_STR("DERIVATION_RESTRICTION"), JS_INT(xercesc_3_1::DOMTypeInfo::DERIVATION_RESTRICTION));
    v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->Set(JS_CONTEXT,JS_STR("DERIVATION_UNION"), JS_INT(xercesc_3_1::DOMTypeInfo::DERIVATION_UNION));

    /**
     * DOMTypeInfo prototype methods
     */
    typeinfot->Set(JS_CONTEXT,JS_STR("~DOMTypeInfo"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_typeinfo_destructor));
    ttypeinfo->Set(JS_CONTEXT,JS_STR("getTypeName"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_typeinfogettypename));
    ttypeinfo->Set(JS_CONTEXT,JS_STR("getTypeNamespace"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_typeinfogettypenamespace));
    ttypeinfo->Set(JS_CONTEXT,JS_STR("isDerivedFrom"), v8::FunctionTemplate::New(JS_ISOLATE, xdom::_typeinfoisderivedfrom));
  ...
  exports->Set(JS_CONTEXT,JS_STR("DOMException"),v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomexcpt)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMImplementation"),v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdom)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMImplementationLS"),v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomls)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMImplementationSource"),v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomsource)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMImplementationRegistry"),v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fdomreg)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMLSParser"), v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fparser)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMLSSerializer"), v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fserializer)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMTypeInfo"), v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::ftypeinfo)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("DOMNode"),v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fnode)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("XMLURL"), v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fxmlurl)->GetFunction());
  exports->Set(JS_CONTEXT,JS_STR("MemBufInputSource"), v8::Local<v8::FunctionTemplate>::New(JS_ISOLATE, xdom::fmembufinput)->GetFunction());
}
